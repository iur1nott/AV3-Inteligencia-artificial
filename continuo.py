...
# =====================================================
# implementação das funções (8 problemas)
# =====================================================
...
# função, restrições para x1 e x2, e se a função objetivo é de maximização
funcoes = {
...
def visualizar_solucoes(n_funcao, resultados):
    f, limites, _ = funcoes[n_funcao]
...
for i in range(1,9):
    visualizar_solucoes(i, resultados)